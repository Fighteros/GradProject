...
class CreatePatient extends StatefulWidget {
  ...
  @override
  State<CreatePatient> createState() => _CreateState();
}

class _CreateState extends State<CreatePatient> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppAdminCubit, CreateAdminStates>(
      listener: (context, state) {
        ...
        if (state is AppCreatePatientSuccessStates) {
        ...
        } else if (state is AppCreatePatientErrorStates) {
          Fluttertoast.showToast(
            msg: "Couldn't create Patient with that email",
            toastLength: Toast.LENGTH_LONG,
            gravity: ToastGravity.BOTTOM,
            timeInSecForIosWeb: 1,
                    ...
                    children: [
                      ...
                      Center(
                        child: ConditionalBuilder(
                          condition: state is! AppCreatePatientLoadingStates,
