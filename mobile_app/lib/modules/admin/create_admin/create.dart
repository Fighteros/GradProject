...
class CreateAdmin extends StatefulWidget {
  ...
  @override
  State<CreateAdmin> createState() => _CreateState();
}

class _CreateState extends State<CreateAdmin> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppAdminCubit, CreateAdminStates>(
      listener: (context, state) {
        ...
        if (state is AppCreateAdminSuccessStates) {
        ...
        } else if (state is AppCreateAdminErrorStates) {
          Fluttertoast.showToast(
            msg: "Couldn't create admin with that email",
            toastLength: Toast.LENGTH_LONG,
            gravity: ToastGravity.BOTTOM,
            timeInSecForIosWeb: 1,
                    ...
                    children: [
                      ...
                      Center(
                        child: ConditionalBuilder(
                          condition: state is! AppCreateAdminLoadingStates,
