        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                defultButton(
                  ...
                  changeText: 'Create Doctor',
                  onPressed: () {
                    navigateTo(context, const CreateDoctor());
                  },
                ),
                const SizedBox(
                  width: 20,
                ...
                defultButton(
                  height: 100,
                  changeColor: btnsColor,
                  changeText: 'Delete Doctor',
                  onPressed: () {
                    navigateTo(context, DeleteDoctor());
                  },
                ),
              ],
            ),
            ...
            defultButton(
              ...
              width: 190,
              changeColor: btnsColor,
              changeText: 'Updata Doctor',
              onPressed: () {
                navigateTo(context, UpdateDoctor());
              },
            ),
          ],
        ),
